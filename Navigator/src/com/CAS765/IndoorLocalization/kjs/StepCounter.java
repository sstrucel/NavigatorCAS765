...
import com.CAS765.IndoorLocalization.kjs.HighPassFIR;
import com.CAS765.IndoorLocalization.kjs.LowPassFIR;
import com.CAS765.IndoorLocalization.kjs.Tool;
...
public class StepCounter {
	...
	public StepCounter(Activity activity){
		//Create callback to talk to other class
		try {
	...
	/** Pushes data into the step counter to be processed
	 * @param xR Accelerometer reading in the X axis
	 * @param yR Accelerometer reading in the Y axis
	 * @param zR Accelerometer reading in the Z axis
	 */
	...
	//Simple Filter for step events that occur too frequently 
	private void filterSmallSteps()
	{
		if(firstStep)
		{
	...
	//Unused filtering for step event that produces regularly timed step event based on the average step occurance
	private void stepFilter()
	{
		stepsTaken++;
		if (firstStep)
		{
	...
	//Unused TimerTask to fire step events at a changing period
